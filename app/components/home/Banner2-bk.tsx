...
const Banner2 = () => {
  return (
    <div className="relative flex flex-col items-center justify-center py-[50px] gap-4 font-poppins text-center bg-[url('/bgbanner2.png')] bg-cover bg-center bg-no-repeat">
      <h1
        className="text-5xl md:text-6xl lg:text-8xl text-white font-bold"
        style={{
          textShadow: `
            -3px -3px 0 #004aad,
            3px -3px 0 #004aad,
      ...
      <h1
        className="text-xl md:text-2xl lg:text-4xl text-white font-bold max-w-2xl px-4"
        style={{
          textShadow: `
            -3px -3px 0 #004aad,
            3px -3px 0 #004aad,
      ...
      <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-around w-full">
        {/* Mobile/Tablet Layout (flex-col) */}
        <div className="flex flex-col items-center justify-center px-4 lg:hidden">
          <p className="text-xl text-[#005e92] mb-2 px-2 py-1 bg-white rounded-md font-semibold mt-4">
            Protect Your Pet!
          </p>
          <p className="text-sm md:text-base text-[#004aad] text-center p-2 mt-2 bg-blue-100 rounded-md">
            Your pet’s health answers — anytime, anywhere. Meet your personal AI
            veterinary assistant — a smart, conversational companion that talks
            with you naturally (not just a simple text bot). Available 24/7 on
            your phone or computer, it helps you check if foods, chemicals, or
            plants are dangerous, guides you step by step during emergencies,
            and pinpoints the closest emergency vet when every second counts. While not a
            replacement for your veterinarian, it gives you instant, trustworthy answers and
            peace of mind whenever you need them. Subscribe now and keep expert pet health
            advice at your fingertips.
          </p>
          <div className="relative w-full h-[400px] mt-8">
            <Image src="/animals.svg" alt="Pet animals" fill className="object-contain" />
          </div>

          <div className="grid grid-cols-2 gap-4 mt-8 w-full">
            <div className="w-full h-32 bg-[#005e92] rounded-full flex items-center justify-center text-white text-base font-bold text-center p-2">
              <p>Speak to an Expert 24/7</p>
            </div>
            <div className="w-full h-32 bg-[#005e92] rounded-full flex items-center justify-center text-white text-base font-bold flex-col p-2">
              <svg
              ...
              <p>Pet Medicine Explanations</p>
            </div>
            <div className="w-full h-32 bg-[#005e92] rounded-full flex items-center justify-center text-white text-base font-bold flex-col p-2">
              <Image src="/food.svg" alt="Pet food" width={40} height={40} />
              <p>
                Pet Food <br /> Advice
              </p>
            </div>
            ...
            <div className="w-full h-32 bg-[#005e92] rounded-full flex items-center justify-center text-white text-base font-bold flex-col p-2">
              <Image src="/collar.svg" alt="Collar" width={40} height={40} />
              <p>
                General <br /> Advice
              </p>
            </div>
        ...
        {/* Large Screen Layout (flex-row) */}
        <div className="hidden lg:flex items-center justify-around w-full">
          <div className="w-[68%]">
            <p
              className="text-3xl text-[#005e92] mb-2"
              style={{
                textShadow: `
                  -1px -1px 0 #ffffffff,
                  1px -1px 0 #ffffffff,
            ...
            <p
              className="text-[#004aad] bg-blue-100"
              style={{ display: 'inline', padding: '2px' }}
            >
              Your pet’s health answers — anytime, anywhere. Meet your personal AI
              veterinary assistant — a smart, conversational companion that talks with
              you naturally (not just a simple text bot). Available 24/7 on your phone or
              computer, it helps you check if foods, chemicals, or plants are dangerous,
              guides you step by step during emergencies, and pinpoints the closest
              emergency vet when every second counts. While not a replacement for your
              veterinarian, it gives you instant, trustworthy answers and peace of mind
              whenever you need them. Subscribe now and keep expert pet health advice at
              your fingertips.
            </p>
            <Image
              src="/animals.svg"
            ...
            />
            <div
              className="flex flex-row gap-14 -mt-25"
