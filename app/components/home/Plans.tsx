          ...
          <div className="bg-[#ffb930] rounded-3xl p-8 md:p-12 text-black shadow-lg flex flex-col justify-between">
            <div>
              ...
              <p className="text-[16px] md:text-[18px] leading-relaxed mb-4">
                Dip your paws in! <br />
                <strong>No commitment,</strong> just minutes on demand — perfect
                for checking out Vet365 AI and seeing the magic. <br />
                🐾 <strong>Just Sniffing It Out</strong> – 10-minute intro,
                $5.99
              </p>

              <p className="text-[16px] md:text-[18px] leading-relaxed mb-4">
                A little sniff before you commit! Perfect for first-timers who
                want to meet Kora, ask a quick question, and see how the magic
                works. Your Welcome Wag is waiting — tail wags guaranteed, no
                strings attached.
              </p>
              <div className="border-b border-black w-70 mb-6"></div>
              ...
              <ul className="space-y-2 text-[16px] md:text-[18px] leading-relaxed mt-4">
                <li>
                  🦴 <strong>10 minutes of real-time guidance</strong>
                </li>
                ...
                <li>
                  🎉 First-time intro offer included — you’ll be feline fine in
                  no time
                </li>
                <li>
          ...
          <div className="bg-[#47e5d2] rounded-3xl p-8 md:p-12 text-black shadow-lg flex flex-col justify-between">
            <div>
              ...
              <ul className="space-y-2 text-[16px] md:text-[18px] leading-relaxed">
                ...
                <li>
                  💬 <strong>Real-time answers, day or night</strong> <br />— no
                  waiting, no whining
                </li>
                <li>
                ...
                <li>
                  🐾 <strong>Monthly plan = worry-free peace of mind</strong>{" "}
                  <br />
            ...
            <div className="mt-8">
              <button
                ...
                className="bg-black text-white px-6 py-3 rounded-full font-semibold text-[16px] hover:bg-gray-900 transition mb-4"
              >
                Join the Pack
              </button>
