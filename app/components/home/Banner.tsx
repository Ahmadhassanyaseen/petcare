...
export default function Banner5() {
  return (
    <section className="w-full font-[Poppins]">
      {/* 🟪 Main Banner */}
      <main className="main_banner bg-[#B57DFF] flex flex-col items-center text-center  relative overflow-hidden">
        <div>
          <h1
            className={`${syne.variable} font-syne banner_heading font-extrabold leading-none tracking-tight text-black mt-2  `}
            style={{
              lineHeight: "0.9em",
          ...
          <div className="ml-[0x]  md:ml-[120px]  lg:ml-[100px] text-start text-[12px] sm:text-base md:text-[16px] lg:text-lg text-black/90 font-medium">
            <p className="italic ml-[60px] md:ml-[40px] lg:ml-[60px] mt-3">
        ...
        {/* 🐶 Dog Image Section */}
        {/*  w-[80%] sm:w-[70%] md:w-[60%] lg:w-[60%] */}
        <div className="image_container mt-0 flex justify-center">
          <Image
            src="/Dog.avif"
            alt="Dog"
            width={720}
