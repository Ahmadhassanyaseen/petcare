...
const Banner2 = () => {
  return (
    <div className='relative flex flex-col items-center justify-center py-[50px] gap-4 font-poppins text-center bg-[url("/mainBg.png")] bg-cover bg-center bg-no-repeat'>
      <h1
  ...
  `,
      ...
      >
        Get Expert Answers 24/7
      </h1>

      <p className="text-2xl font-bold text-[#005e92]">Protect Your Pet</p>
      <Image
        src="/animals.svg"
        alt="arrow"
        width={800}
      ...
      <div className="flex flex-row gap-4 -mt-20">
        <div className="w-[200px] h-[200px] bg-[#005e92] rounded-full flex items-center justify-center text-white text-2xl font-bold -mt-20">
          <p>Speak to an Expert 24/7</p>
        </div>
        <div className="w-[200px] h-[200px] bg-[#005e92] rounded-full flex items-center justify-center text-white text-2xl font-bold flex-col">
          <svg
        ...
        <div className="w-[200px] h-[200px] bg-[#005e92] rounded-full flex items-center justify-center text-white text-2xl font-bold flex-col gap-2">
          <Image src="/food.svg" alt="arrow" width={50} height={50} />
          <p>Pet Food <br /> Advice</p>
        </div>
        <div className="w-[200px] h-[200px] bg-[#005e92] rounded-full flex items-center justify-center text-white text-2xl font-bold -mt-20 flex-col gap-2">
