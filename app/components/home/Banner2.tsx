  ...
  `,
            ...
            src="/animals.svg"
              ...
              <div className="flex flex-row gap-16 -mt-20">
                <div className="w-[160px] h-[160px] bg-[#005e92] rounded-full flex items-center justify-center text-white text-xl font-bold -mt-20">
                  <p>Speak to an Expert 24/7</p>
                </div>
                <div className="w-[160px] h-[160px] bg-[#005e92] rounded-full flex items-center justify-center text-white font-bold flex-col">
                  <svg
                ...
                <div className="w-[160px] h-[160px] bg-[#005e92] rounded-full flex items-center justify-center text-white font-bold flex-col gap-2">
                  <Image src="/food.svg" alt="arrow" width={50} height={50} />
                  <p>Pet Food <br /> Advice</p>
                </div>
                <div className="w-[160px] h-[160px] bg-[#005e92] rounded-full flex items-center justify-center text-white font-bold -mt-20 flex-col gap-2">
