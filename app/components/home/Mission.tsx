      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 max-w-7xl w-full mx-auto">
        ...
        <div className="bg-[#ffb930] rounded-3xl p-8 md:p-12 text-black flex flex-col justify-center shadow-lg">
          ...
          <p className="text-[16px] md:text-[18px] leading-relaxed mb-4">
            ...
            <br />
            to bring together the <strong>heart of a real veterinarian</strong> and
            the <strong>brains of cutting-edge AI</strong> so pet parents
            everywhere can get instant answers and real peace of mind day, night,
            or treat-time.
          </p>
          ...
          <p className="text-[16px] md:text-[18px] leading-relaxed mb-4">
            ...
            <strong>step-by-step guidance</strong> to help you go from anxious to
            assured in a single conversation — <em>any day, any hour.</em>
          </p>
